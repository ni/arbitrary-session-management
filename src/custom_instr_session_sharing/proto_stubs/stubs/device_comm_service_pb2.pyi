...
class InitializeRequest(google.protobuf.message.Message):
    ...
    """Custom instrument resource name."""
    ...
    def ClearField(self, field_name: typing.Literal["initialization_behavior", b"initialization_behavior", "protocol", b"protocol", "register_map_path", b"register_map_path", "reset", b"reset", "resource_name", b"resource_name"]) -> None: ...
